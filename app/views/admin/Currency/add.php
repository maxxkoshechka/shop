...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?=ADMIN;?>/currency"><i class="fa fa-dashboard"></i> Список валют</a></li>
                ...
                <form action="<?=ADMIN;?>/currency/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="title" class="form-control" id="title" placeholder="Название валюты" required>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="value" class="form-control" id="value" placeholder="Значение" required data-error="Допускаются цифры и точка" pattern="^[0-9.]{1,}$">
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
